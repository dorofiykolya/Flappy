package com.api.forticom
{
	...
	public class ForticomAPI extends EventDispatcher
	{
		...
		public function ForticomAPI(key : SingleTonKey) 
		{
			...
			//this._connection.addEventListener(SecurityErrorEvent.SECURITY_ERROR
		...
		{
			ForticomAPI.instance.doSend("showPermissions", com.adobe.serialization.json.JSON.encode(permissions));
		}
