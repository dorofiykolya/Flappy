...
package com.junkbyte.console.view 
{
	...
	public class PanelsManager{
		...
		public function updateGraphs(graphs:Array):void{
			...
			if(fpsGroup != null){
				if (_fpsPanel == null) {
					_fpsPanel = new GraphingPanel(console, 200 ,100, GraphingPanel.FPS);
					_fpsPanel.name = GraphingPanel.FPS;
					_fpsPanel.x = _mainPanel.x+_mainPanel.width-200;
			...
			if(memGroup != null){
				if(_memPanel == null){
					_memPanel = new GraphingPanel(console, 200 ,100, GraphingPanel.MEM);
					_memPanel.name = GraphingPanel.MEM;
					_memPanel.x = _mainPanel.x+_mainPanel.width-200;
