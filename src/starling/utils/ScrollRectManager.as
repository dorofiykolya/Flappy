package starling.utils
{
	...
	import starling.display.ScrollerDisplayObjectContainer;
	...
	public class ScrollRectManager
	{
		...
		public static function adjustTouchLocation(location:Point, target:DisplayObject):void
		{
			...
			while(newTarget.parent)
			{
				...
				if(newTarget is ScrollerDisplayObjectContainer)
				{
					var targetWithScrollRect:ScrollerDisplayObjectContainer = ScrollerDisplayObjectContainer(newTarget);
