...
package starling.utils
{
    ...
    public class MatrixUtil
    {
		...
		public static function transformPoint(matrix:Matrix, point:Point):Point
		{
			var x:Number = matrix.a * point.x + matrix.c * point.y + matrix.tx;
			var y:Number = matrix.d * point.y + matrix.b * point.x + matrix.ty;
			point.x = x;
            point.y = y;
            return point;
		}
