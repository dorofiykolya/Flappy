...
package starling.core
{
	...
	import starling.events.ExceptionEvent;
    ...
    public class Starling extends EventDispatcher
    {
		...
		private var mIsRender:Boolean = true;
		private var mTouchable:Boolean = true;
		
		private var mFrame:uint;
        ...
        private function initialize():void
        {
            ...
            mLastFrameTimestamp = getTimer() / 1000.0;
			mFpsLastTime = mLastFrameTimestamp;
        }
        ...
        private function onEnterFrame(event:Event):void
        {
			...
			if(mIsDebugger == false)
			{
				...
				{
					dispatchEvent(new ExceptionEvent(ExceptionEvent.EXCEPTION, e.name, e.message, e.getStackTrace(), e.errorID, e));
				}
				finally
				{
					return;
