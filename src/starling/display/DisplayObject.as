...
package starling.display
{
    ...
    public class DisplayObject extends EventDispatcher
    {
		...
		public function get includeInParentBounds():Boolean 
		{
			return mIncludeInParentBounds;
		}
		
		public function set includeInParentBounds(value:Boolean):void 
		{
			mIncludeInParentBounds = value;
		}
		
		public function RemoveFromParent(dispatchRemove:Boolean = false, dispatchRemoveFromStage:Boolean = false, dispose:Boolean = false):void 
		{
			if (mParent)
			{
				mParent.RemoveChild(this, dispatchRemove, dispatchRemoveFromStage, dispose);
			}
		}
    }
}