    ...
    public class ParticleSystem extends DisplayObject implements IAnimatable
    {
        ...
        public function advanceTime(passedTime:Number):void
        {
            ...
            for (var i:int=0; i<mNumParticles; ++i)
            {
				...
				//1
				mVertexData.setColor(vertexID + 1, color);
				mVertexData.setAlpha(vertexID + 1, alpha);
				//2
				mVertexData.setColor(vertexID + 2, color);
				mVertexData.setAlpha(vertexID + 2, alpha);
				//3
				mVertexData.setColor(vertexID + 3, color);
				mVertexData.setAlpha(vertexID + 3, alpha);
